    ...
    <MainForm>
      <SearchWrapper>
        ...
        <section className="bookListSection">
          {!checkInSearch 
            ? <SearchLoading />
            : bookLists.map((el) => <BookList bookList={el} key={uuid()} clickedBook={clickedBook}/>)}
        </section>
        {clickBookInfoModal.click 
          ?<div>
            <ClickModal clickBook={clickBookInfoModal.clickBook} modalClose={modalClose} modalSaveBookInfo={modalSaveBookInfo}/>
